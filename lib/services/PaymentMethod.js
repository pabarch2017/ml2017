...
class PaymentMethodService {
    ...
    // I need to use this method because I cannot retrieve a list of payment methods in one request (ids attribute
    // does not work in "/sites/MLA/payment_methods" endpoint)
    findById(id) {
        if (!id) {
